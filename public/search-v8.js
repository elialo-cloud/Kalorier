...
const clear=document.querySelector('#clearSearch');if(clear)clear.addEventListener('click',e=>{e.stopImmediatePropagation();kInput.value='';clear.hidden=true;kSearch('');kInput.focus()},true);
